...
os. chdir("C:\Research\HRR_BorgMOEA_VIC")    #working directory
nvars = 6           #number of parameters for calibration
nobjs = 5           #number of objectives
pos = [10,11,62,65,66,67] #parameter position (line number) in input.txt
...
borg.setBounds([10,200],[1,20],[0.0005,0.5],[0.00000001,0.003],[0.00000001,0.005],[0.92,1.0])
