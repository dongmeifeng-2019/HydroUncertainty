...
library(stringr)
library(e1071)
setwd("D:/UncertaintyPaper/PaperOutput_revision_new/runoff/S1SS1/VIC")
...
system(paste('C:\\Windows\\SysWOW64\\cmd.exe /K "VIC.exe"'), intern = FALSE,ignore.stdout = FALSE, 
...
file.rename("subsurface_runoff_mmpm.txt",'subsurface_runoff_mmpm_1984_VIC_ex.txt')
file.rename("surface_runoff_mmpm.txt",'surface_runoff_mmpm_1984_VIC_ex.txt')