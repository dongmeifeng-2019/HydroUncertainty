...
error_RCM = read.table('data/cal_metrics_VIC_Borg_new.txt',header=F)
...
write.table(para_final_RCM,'cache/para_final_VIC.txt',col.names = F, row.names = F, append = F)
