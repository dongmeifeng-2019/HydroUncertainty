...
error_RCM = read.table('data/cal_metrics_STP_Borg.txt',header=F)
...
write.table(para_final_RCM,'cache/para_final_STP.txt',col.names = F, row.names = F, append = F)
