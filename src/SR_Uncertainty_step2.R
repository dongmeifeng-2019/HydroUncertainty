...
input_txt <- 'sr_monthly_uncertain_19.txt'        #"q100_uncertain.txt"  'max_uncertain.txt'
...
for(WID in 1:12){
  ...
  write.table(t(s),'sr_monthly_uncertainty_19.txt',quote = FALSE, row.names = FALSE, col.names=FALSE,append=TRUE)
}
